...
for (out in out_vars) {
  ...
  for (oaxes in out_axes_vars) {
    ...
    output_path <- file.path ("output", paste0("kerasScra_ES30_", out, "_",oaxes, ".h5"))
...
fileNames <- list.files("output/", "kerasScra_ES30_")
...
pdf ("output/deepScratch_ES30.pdf", width = 20, height = 10)
f2
dev.off ()

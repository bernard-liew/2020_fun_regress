...
for (out in out_vars) {
  ...
  for (oaxes in out_axes_vars) {
    ...
    output_path <- file.path ("output", paste0("kerasTLpunfrz_ES30_", out, "_",oaxes, ".h5"))
...
fileNames <- list.files("output/", "kerasTLpunfrz_ES30")
...
pdf ("output/deepTLpunfrz_ES30.pdf", width = 20, height = 10)
f2
dev.off ()
